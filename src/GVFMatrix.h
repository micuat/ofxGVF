...
//--------------------------------------------------------------
template <typename T>
inline vector< vector<T> > multiplyMat(vector< vector<T> > & M1, T v){
...
//--------------------------------------------------------------
template <typename T>
inline vector< vector<T> > multiplyMat(vector< vector<T> > & M1, vector< vector<T> > & M2){
...
//--------------------------------------------------------------
template <typename T>
inline float getNorm2(vector<T>& V){
    float tSum = 0.0f;
    for (int n=0; n<V.size(); n++){
        tSum += pow(V[n],2);
    }
...
//--------------------------------------------------------------
template <typename T>
inline float distanceEuclidean(vector<T>& V1, vector<T>& V2){
    assert(V1.size() == V2.size()); // columns in M1 == rows in Vect
    float tSum = 0.0f;
    for (int n=0; n<V1.size(); n++){
        tSum += pow(V1[n]-V2[n],2);
    }
    return sqrt(tSum);
}
